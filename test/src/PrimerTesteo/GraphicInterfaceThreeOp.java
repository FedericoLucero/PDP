...
public class GraphicInterfaceThreeOp extends JPanel {
    ...
    public GraphicInterfaceThreeOp() {
    ...
    private void addButtons() {
        addButton("Change Position ", "Button 1");
        addButton("Rotate Boat     ", "Button 2");
        addButton("Save Boat       ", "Button 3");
